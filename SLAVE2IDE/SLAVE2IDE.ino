...
void scaralayly(){
  run(0, 6500, 8800, 1320, 10000);
  scaradongkep();
  run(0, 6500, 8800, 1320, 7000);
}
void scaranguyenlieu1(){
  run(0, 3500, 3500, 600, 6000);
  run(0, 5500, 3000, 2500, 6000);
  run(0, 2850, 5500, 2050, 6000);
}
void scaranguyenlieu2(){
  run(0, 3250, 4500, 2100, 6000);
}
void scaranguyenlieu3(){
  run(0, 3450, 3750, 2100, 6000);
}
void scaranguyenlieu4(){
  run(0, 3550, 2850, 2000, 6000);
}
void scaraice(){
  run(0, 5000, 8000, 600, 6000);
  run(0, 5500, 10000, 1100, 6000);
}
void scarakhuay(){
  run(0, 4000, 1400, 2000, 6000);
  run(0, 2400, 2300, 1700, 6000);
  run(0, 2400, 2400, 1700, 500);
}
void scarakhuayend(){
  run(0, 2400, 2400, 1700, 6000);
  run(0, 3500, 300, 1500, 6000);
}
void scaratrahang(){
  run(0, 4200, 7900, 2000, 6000);
  run(0, 4200, 7900, 2000, 12000);
  scaramokep();
  delay(100);
  run(0, 4200, 8000, 2100, 12000);
  run(0, 4200, 8200, 2200, 12000);
  run(0, 4200, 8200, 2200, 10000);
}
void scaraend(){
  delay(5000);
 // run(0, 3900, 7800, 1500, 12000);
  run(0, 3200, 7000, 1100, 12000);
  run(0, 4000, 300, 800, 12000);
  run(0, 4000, 300, 800, 2000);
  run(0, 500, 300, 500, 1000);
  homeZ();
  homeXY();
  homeA();
...
void setup() {
  ...
  // scaraend();
  // run(0, 3000, 300, 300, 2000);
  // run(0, 3000, 300, 1500, 2000);
  // scaramokep();
  // delay(2000);
  // scaradongkep();
  
  // run(0, 6100, 4600, 2000, 6000);

  // run(0, 4100, 8000, 2000, 6000);
  // run(0, 4100, 8000, 2000, 12000);
  // scaramokep();

  // run(0, 6100, 4600, 2000, 6000);
  // run(0, 6100, 4600, 2000, 11500);
  // scaramokep();
  // run(0, 6200, 4800, 2300, 11500);
  // run(0, 6500, 5000, 2400, 11500);
  // run(0, 6500, 5800, 1500, 11500);
