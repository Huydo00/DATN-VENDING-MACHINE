...
void cangDay(int timeday){
  digitalWrite(ENL298N,HIGH);
  digitalWrite(M1L298N,HIGH);
  digitalWrite(M2L298N,LOW);
  delay(timeday);
  digitalWrite(ENL298N,LOW);
}
void cangRut(int timerut){
  digitalWrite(ENL298N,HIGH);
  digitalWrite(M1L298N,LOW);
  digitalWrite(M2L298N,HIGH);
  delay(timelayhang*1000);
  digitalWrite(ENL298N,LOW);
}
...
void setup() {
  ...
  pinMode(M1L298N, OUTPUT);
  pinMode(M2L298N, OUTPUT);
  pinMode(ENL298N, OUTPUT);
