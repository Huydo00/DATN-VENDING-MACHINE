...
void loop(){
  ...
  if(CAFEDENDAKHONGDUONG == 1){   //lay ly -> 40ml cafe -> 5g duong -> khuay -> da -> 5ml cafe -> tra

  }
  if(CAFEDENDACODUONG == 1){      //lay ly -> 40ml cafe -> khuay -> da -> 5ml cafe -> tra             //Công thức này coi lại

  }
  if(CAFEDENNONGCODUONG == 1){    //lay ly -> 40ml cafe -> 5g duong -> khuay -> 5ml cafe -> tra       //Công thức này coi lại
    
  }
  if(CAFESUADA == 1){             //lay ly -> 40ml cafe -> 25ml sua -> khuay -> da -> 5ml cafe -> tra
